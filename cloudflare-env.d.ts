/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 3420b3c67a699cd572c8ab22031485e4)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "S3_ENDPOINT" | "S3_REGION" | "S3_BUCKET" | "S3_ADDRESSING_STYLE" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "S3_SESSION_TOKEN">> {}
}
