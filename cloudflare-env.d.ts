/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 3fa05c08435017b9e34aeecef3073bc9)
// Runtime types generated with workerd@1.20260903.1 2026-08-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	APP_ENV: string;
	BETTER_AUTH_URL: string;
	BETTER_AUTH_SECRET: string;
	SUPERADMIN_BOOTSTRAP_TOKEN: string;
	SUPERADMIN_BOOTSTRAP_EMAIL: string;
	S3_ENDPOINT: string;
	S3_REGION: string;
	S3_BUCKET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "SUPERADMIN_BOOTSTRAP_TOKEN" | "SUPERADMIN_BOOTSTRAP_EMAIL" | "S3_ENDPOINT" | "S3_REGION" | "S3_BUCKET" | "S3_ADDRESSING_STYLE" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "S3_SESSION_TOKEN">> {}
}
