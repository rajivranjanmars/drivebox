/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 89a33f517734ae77d1a6107da91c3343)
// Runtime types generated with workerd@1.20260811.1 2026-08-12 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "STORAGE_BACKEND" | "S3_ENDPOINT" | "S3_REGION" | "S3_BUCKET" | "S3_ADDRESSING_STYLE" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "S3_SESSION_TOKEN">> {}
}
