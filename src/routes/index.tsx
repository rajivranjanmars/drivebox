...
const features = [
  ...
  {
    icon: FolderSync,
    title: "Folders stay intact",
    description: "Upload an entire folder and DriveBox preserves its structure inside your private account root.",
  },
  {
    icon: Zap,
    title: "Uploads that recover",
    description: "Large files are split into retryable chunks, so a brief connection problem does not restart everything.",
  },
];
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "DriveBox — Your private cloud workspace" },
      { name: "description", content: "A fast, private, folder-aware workspace with resumable uploads." },
    ],
  }),
  component: Home,
});
        ...
        <div className="page-shell grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
          <div className="mx-auto max-w-2xl text-center lg:mx-0 lg:text-left">
            ...
            <p className="mx-auto mt-6 max-w-xl text-pretty text-base leading-7 text-muted-foreground sm:text-lg lg:mx-0">
              Upload files or whole folders, pause when needed, and continue safely—without exposing public links or storage credentials.
            </p>
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              ...
              <Button asChild size="lg" variant="outline">
                <Link to="/sign-in">Open your workspace</Link>
              </Button>
            </div>
            <div className="mt-6 flex flex-wrap justify-center gap-x-5 gap-y-2 text-xs font-medium text-muted-foreground lg:justify-start">
              {["Private object storage", "Folder paths preserved", "Up to 50 GiB per file"].map((item) => (
